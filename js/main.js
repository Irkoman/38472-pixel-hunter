...
/***/ function(module, exports, __webpack_require__) {
	...
	window.fetch('https://intensive-ecmascript-server-nnpnvhhedl.now.sh/pixel-hunter/questions').then(function (response) {
	  return _application2.default.checkStatus(response);
	}).then(function (response) {
	  return response.json();
	}).then(function (data) {
	  _application2.default.data = data;
	}).then(_application2.default.showIntro).catch(_application2.default.showError);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _save = __webpack_require__(307);
	...
	var _game = __webpack_require__(309);
	...
	var Application = function () {
	  ...
	  _createClass(Application, null, [{
	    ...
	    key: 'showGame',
	    value: function showGame(username) {
	      changeView((0, _game2.default)(username, gameData));
	    }
	  }, {
	    key: 'showStats',
	    value: function showStats(stats) {
	      changeView((0, _stats2.default)(stats));
	    }
	  }, {
	    key: 'showError',
	    value: function showError() {
	      changeView((0, _error2.default)());
	    }
	  }, {
	    key: 'showSave',
	    value: function showSave() {
	      changeView((0, _save2.default)());
	    }
	  }, {
	    key: 'checkStatus',
	    ...
	    key: 'saveStats',
	    value: function saveStats(state) {
	      var _this = this;
	
	      var SERVER = 'https://intensive-ecmascript-server-dxttmcdylw.now.sh/pixel-hunter/stats';
	...
	var IntroView = function (_AbstractView) {
	  ...
	  _createClass(IntroView, [{
	    ...
	    value: function bindHandlers() {
	      var introAsterisk = this.element.querySelector('.intro__asterisk');
	
	      introAsterisk.addEventListener('click', function () {
	        return _application2.default.showGreeting();
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GreetingView = function (_AbstractView) {
	  ...
	  function GreetingView() {
	    ...
	    return _possibleConstructorReturn(this, (GreetingView.__proto__ || Object.getPrototypeOf(GreetingView)).apply(this, arguments));
	  }
	  ...
	  _createClass(GreetingView, [{
	    ...
	    value: function bindHandlers() {
	      ...
	      greetingContinue.addEventListener('click', function () {
	        return _application2.default.showRules();
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RulesView = function (_AbstractView) {
	  ...
	  function RulesView() {
	    ...
	    var _this = _possibleConstructorReturn(this, (RulesView.__proto__ || Object.getPrototypeOf(RulesView)).call(this));
	
	    _this._header = new _header2.default();
	    _this._header.onBackClick = function () {
	      return _application2.default.showGreeting();
	    };
	    _this.element.insertBefore(_this._header.element, _this.element.firstChild);
	    return _this;
	  }
	...
	var HeaderView = function (_AbstractView) {
	  ...
	  _createClass(HeaderView, [{
	    ...
	    value: function bindHandlers() {
	      ...
	      var backButton = this.element.querySelector('.header__back');
	
	      backButton.addEventListener('click', function () {
	        return _this2._onBackClick();
	      });
	    }
	  }, {
	    key: '_renderLives',
	    value: function _renderLives() {
	      var gameLives = '';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StatsView = function (_AbstractView) {
	  ...
	  function StatsView(stats) {
	    ...
	    _this._stats = stats.map(function (item) {
	      return (0, _gameController.formatStats)(item);
	    });
	    _this._header = new _header2.default();
	    _this._header.onBackClick = function () {
	      return _application2.default.showIntro();
	    };
	    _this.element.insertBefore(_this._header.element, _this.element.firstChild);
	    return _this;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.formatStats = exports.getSlowExtra = exports.getFastExtra = exports.getLivesExtra = exports.computeTotal = exports.computeScore = exports.setVerdict = exports.isGameOver = exports.setStats = exports.setCurrentQuestion = exports.setLives = exports.setTime = exports.rateAnswerSpeed = exports.Answer = exports.initialGame = exports.initGame = undefined;
	
	__webpack_require__(9);
	
	var initGame = exports.initGame = function initGame(game) {
	  return JSON.parse(JSON.stringify(game));
	};
	
	var initialGame = exports.initialGame = {
	  time: 30,
	  lives: 3,
	  question: 0,
	  stats: Array.from(new Array(10), function () {
	    return 'unknown';
	  })
	};
	...
	var rateAnswerSpeed = exports.rateAnswerSpeed = function rateAnswerSpeed(time) {
	  if (time < 10) {
	    return Answer.SLOW;
	  } else if (time < 20) {
	...
	var setTime = exports.setTime = function setTime(game, number) {
	  if (number < 0) {
	...
	var setLives = exports.setLives = function setLives(game, number) {
	  if (number < 0) {
	...
	var setCurrentQuestion = exports.setCurrentQuestion = function setCurrentQuestion(game, number) {
	  if (number < 0) {
	...
	var setStats = exports.setStats = function setStats(game, answer) {
	  var gameInProgress = JSON.parse(JSON.stringify(game));
	  gameInProgress.stats[gameInProgress.question] = answer;
	  return gameInProgress;
	};
	
	var isGameOver = exports.isGameOver = function isGameOver(game) {
	  return game.lives <= 0;
	};
	
	var setVerdict = exports.setVerdict = function setVerdict(lives) {
	  return lives > 0 ? 'Победа!' : 'Фэйл';
	};
	
	var computeScore = exports.computeScore = function computeScore(game) {
	  if (game.lives === 0) {
	    return 0;
	  }
	
	  var correctAnswers = game.stats.filter(function (answer) {
	    return answer !== Answer.UNKNOWN && answer !== Answer.WRONG;
	  });
	  return correctAnswers.length * 100;
	};
	
	var computeTotal = exports.computeTotal = function computeTotal(score, extra) {
	  return extra.reduce(function (prev, cur) {
	    return prev + cur.score;
	  }, score);
	};
	
	var getLivesExtra = exports.getLivesExtra = function getLivesExtra(game) {
	  if (game.lives === 0) {
	    return [];
	  }
	...
	var getFastExtra = exports.getFastExtra = function getFastExtra(game) {
	  var fastAnswers = game.stats.filter(function (answer) {
	    return answer === Answer.FAST;
	  });
	...
	var getSlowExtra = exports.getSlowExtra = function getSlowExtra(game) {
	  var slowAnswers = game.stats.filter(function (answer) {
	    return answer === Answer.SLOW;
	  });
	...
	var formatStats = exports.formatStats = function formatStats(game) {
	  var extra = getLivesExtra(game).concat(getFastExtra(game)).concat(getSlowExtra(game));
	  var score = computeScore(game);
	  var total = computeTotal(score, extra);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(18)(IteratorPrototype, __webpack_require__(33)('iterator'), function () {
	  return this;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(173)(function (iter) {
	  Array.from(iter);
	}), 'Array', {
	...
	var USE_NATIVE = !!function () {
	  try {
	    ...
	    var promise = $Promise.resolve(1),
	        FakePromise = (promise.constructor = {})[__webpack_require__(33)('species')] = function (exec) {
	      exec(empty, empty);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(302)(module), __webpack_require__(303)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SaveView = function (_AbstractView) {
	  _inherits(SaveView, _AbstractView);
	
	  function SaveView() {
	    _classCallCheck(this, SaveView);
	
	    return _possibleConstructorReturn(this, (SaveView.__proto__ || Object.getPrototypeOf(SaveView)).apply(this, arguments));
	  }
	
	  _createClass(SaveView, [{
	    key: 'getMarkup',
	    value: function getMarkup() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameModel = __webpack_require__(313);
	...
	var GamePresenter = function () {
	  function GamePresenter(model) {
	    _classCallCheck(this, GamePresenter);
	
	    this.model = model;
	    this.header = new _header2.default(this.model.state);
	    this.content = new _level2.default(this.model.state, this.model.getLevelContent());
	  ...
	  _createClass(GamePresenter, [{
	    ...
	    value: function changeLevel() {
	      if (!this.model.hasLevel()) {
	        _application2.default.saveStats(this.model.state);
	        this.exit();
	      }
	      ...
	      var level = new _level2.default(this.model.state, this.model.getLevelContent());
	    ...
	    value: function updateHeader() {
	      var header = new _header2.default(this.model.state);
	    ...
	    key: 'updateContent',
	    value: function updateContent(view) {
	      this.root.replaceChild(view.element, this.content.element);
	      this.content = view;
	    }
	  }, {
	    key: 'answer',
	    value: function answer(isCorrect) {
	      if (!isCorrect) {
	        this.model.reduceLives();
	        this.model.setAnswer(_gameController.Answer.WRONG);
	      } else {
	...
	exports.default = function (username, gameData) {
	  var game = new GamePresenter(new _gameModel2.default(username, gameData));
	  game.startGame();
	  return game.root;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _score = __webpack_require__(311);
	...
	var LevelView = function (_AbstractView) {
	  ...
	  function LevelView(state, levelContent) {
	    ...
	    _this._state = state;
	    _this._score = new _score2.default(state);
	    _this._levelContent = levelContent;
	    return _this;
	  }
	  ...
	  _createClass(LevelView, [{
	    ...
	    value: function getMarkup() {
	      ...
	      switch (this._levelContent.type) {
	        case 'two-of-two':
	          content = '\n          <form class="game__content">\n            ' + this._levelContent.answers.map(function (answer, index) {
	    ...
	    value: function bindHandlers() {
	      ...
	      var answers = this.element.querySelector('.game__content');
	
	      answers.addEventListener('click', function (e) {
	        var answer = e.target.closest('.game__answer') || e.target.closest('.game__option');
	
	        if (answer) {
	          if (_this2._levelContent.type === 'one-of-three') {
	            _this2.tripleAnswerHandler(answer, answers);
	          } else {
	            _this2.singleAnswerHandler(answers);
	          }
	        }
	      });
	    }
	  }, {
	    key: 'singleAnswerHandler',
	    value: function singleAnswerHandler(container) {
	      var _this3 = this;
	
	      var radios = Array.from(container.querySelectorAll('input[type="radio"]:checked'));
	
	      if (radios.length < this._levelContent.answers.length) {
	        return;
	      }
	
	      var isAnswerCorrect = function isAnswerCorrect() {
	        return radios.every(function (radio, index) {
	          return radio.value === _this3._levelContent.answers[index].type;
	        });
	      };
	    ...
	    key: 'tripleAnswerHandler',
	    value: function tripleAnswerHandler(element, container) {
	      var _this4 = this;
	
	      var options = Array.from(container.querySelectorAll('.game__option'));
	
	      var allAnswers = [];
	      var checkedAnswer = '';
	
	      options.forEach(function (option, index) {
	        allAnswers.push(_this4._levelContent.answers[index].type);
	
	        if (option === element) {
	          checkedAnswer = _this4._levelContent.answers[index].type;
	        }
	      });
	
	      var filteredAnswers = allAnswers.filter(function (item) {
	        return item === checkedAnswer;
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScoreView = function (_AbstractView) {
	  _inherits(ScoreView, _AbstractView);
	
	  function ScoreView(gameState) {
	    _classCallCheck(this, ScoreView);
	
	    var _this = _possibleConstructorReturn(this, (ScoreView.__proto__ || Object.getPrototypeOf(ScoreView)).call(this));
	  ...
	  _createClass(ScoreView, [{
	    key: 'getMarkup',
	    value: function getMarkup() {
	      return '\n      <div class="stats">\n        <ul class="stats">\n          ' + this._state.stats.map(function (result) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameModel = function () {
	  function GameModel(username, data) {
	    var state = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _gameController.initialGame;
	  ...
	  _createClass(GameModel, [{
	    ...
	    value: function initTime() {
	      this._state = (0, _gameController.setTime)(this._state, 30);
	    }
	  }, {
	    key: 'nextLevel',
	    value: function nextLevel() {
	      this._state = (0, _gameController.setCurrentQuestion)(this._state, this._state.question + 1);
	    }
	  }, {
	    key: 'hasLevel',
	    value: function hasLevel() {
	      return this._state.question <= this.data.length && typeof this.data[this._state.question] !== 'undefined' && !(0, _gameController.isGameOver)(this._state);
	    }
	  }, {
	    key: 'getLevelContent',
	    ...
	    value: function reduceLives() {
	      this._state = (0, _gameController.setLives)(this._state, this._state.lives - 1);
	    }
	  }, {
	    key: 'rateAnswer',
	    value: function rateAnswer() {
	      return (0, _gameController.rateAnswerSpeed)(this._state.time);
	    }
	  }, {
	    key: 'setAnswer',
	    value: function setAnswer(answer) {
	      this._state = (0, _gameController.setStats)(this._state, answer);
	    }
	  }, {
	    key: 'restart',
	    value: function restart() {
	      this._state = (0, _gameController.initGame)(_gameController.initialGame);
	    }
	  }, {
	    key: 'tick',
	    value: function tick() {
	      this._state = (0, _gameController.setTime)(this._state, this._state.time - 1);
	    }
	  }, {
	    key: 'state',
	    get: function get() {
